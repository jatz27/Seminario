...
@FacesConverter(value = "bloqueConverter")
public class BloqueConverter implements Converter {

    private BloqueFacade ejbFacade;
    ...
    private BloqueFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(BloqueFacade.class).get();
