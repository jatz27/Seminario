...
@FacesConverter(value = "seccionConverter")
public class SeccionConverter implements Converter {

    private SeccionFacade ejbFacade;
    ...
    private SeccionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(SeccionFacade.class).get();
